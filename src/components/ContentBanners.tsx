...
const ContentBanners: React.FC<ThumbnailContentProps> = ({ setSelectedItem })  => {
  return (
    <section className="px-4 py-4 max-w-7xl mx-auto">
      <div className="text-center mb-4">
        ...
        <p className="font-roboto text-gray-800 text-lg">
          To goal is to always build something eye-catching that also drives results. These choice samples go the extra mile by trying to deliver the client's message through elegant animations but not overcomplicating the delivery.
        </p>
      </div>
